...
from ralph.utils import load_prd


def get_story_by_id(prd: dict[str, Any], story_id: str) -> Optional[dict[str, Any]]:
...
def build_display(
    prd: Optional[dict[str, Any]], path: Path, expand_closed: bool = False
) -> Table:
